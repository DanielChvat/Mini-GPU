...
add_files -norecurse [list \
    [file join $repo_root hardware/rtl/top/basys3_sec_gate_top.v] \
    ...
    [file join $repo_root hardware/rtl/security/gate/security_gate.v] \
    [file join $repo_root hardware/rtl/security/gate/sha256_weight_stream.v] \
    ...
    [file join $repo_root hardware/rtl/security/gate/memory_sec.v] \
...
set_property top basys3_sec_gate_top [current_fileset]
update_compile_order -fileset sources_1

synth_design -top basys3_sec_gate_top -part xc7a35tcpg236-1
report_utilization
